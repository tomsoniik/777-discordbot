...
export const trackconfigCommand: Command = {
    data: new SlashCommandBuilder()
        ...
        .addChannelOption((option) => option.setName('channel').setDescription('Domyślny kanał').setRequired(true)),
    execute: async (interaction: ChatInputCommandInteraction) => {
        ...
        await interaction.reply({
            content: `Domyślny kanał powiadomień ustawiony na <#${channel.id}>.`,
