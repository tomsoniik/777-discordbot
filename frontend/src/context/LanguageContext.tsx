...
const translations: Translations = {
  ...
  builder_projects_desc: { en: "Manage your projects and 2D/3D bases", pl: "Zarządzaj swoimi projektami i bazami 2D/3D", ru: "Управляйте своими проектами и 2D/3D базами" },
